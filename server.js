...
let sitetext;
  try {
    ...
    await axios.get(url)
      ...
      let asking = "Verwende diesen HTML Abschnitt und erstelle eine Tabelle mit den hier enthaltenen Informationen, verzichte dabei auf irgendwelche Zwischenberichte oder Erklärung irgendwelcher Arbeitsschritte und gebe nur die Tabelle aus: "+sitetext;
      console.log(asking);
